  ...
  return (
    <section id="hero" className="min-h-screen bg-linear-to-b from-gray-900 via-gray-950 to-gray-950 pt-24 sm:pt-28 lg:pt-32 px-4 sm:px-6 lg:px-8 flex items-center">
      <div className="max-w-7xl mx-auto w-full">
        ...
        {/* Two Column Layout */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start lg:items-center relative z-10">
          {/* Left Column - Content */}
          <div>
            {/* Main Title */}
            ...
            {/* Trust Signal */}
            <div className="flex flex-col sm:flex-row flex-wrap gap-8 text-slate-400 text-sm border-t border-slate-800 pt-8">
          ...
          {personal.profileImage && (
            <div className="relative h-96 sm:h-[450px] lg:h-[600px] flex items-center justify-center">
              {/* Glow effect background */}
              <div className="absolute inset-0 bg-linear-to-br from-amber-600/20 to-cyan-600/20 rounded-3xl blur-2xl opacity-50"></div>
              
              {/* Image Container */}
              <div className="relative h-full rounded-3xl border-2 border-amber-400/30 overflow-hidden group">
                <img
                ...
                />
                {/* Overlay gradient */}
                <div className="absolute inset-0 bg-linear-to-t from-gray-950/40 to-transparent"></div>
              </div>
            </div>
          )}
        </div>
